...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { cores: @produto.cores, disponivel: @produto.disponivel, nome: @produto.nome, price: @produto.price, tamanho: @produto.tamanho, tipo: @produto.tipo } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { cores: @produto.cores, disponivel: @produto.disponivel, nome: @produto.nome, price: @produto.price, tamanho: @produto.tamanho, tipo: @produto.tipo } }
